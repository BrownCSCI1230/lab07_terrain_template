...
//    float A = ... // dot product between top left and its offset
//    float B = ... // dot product between top right and its offset
//    float C = ... // dot product between bottom right and its offset
//    float D = ... // dot product between bottom left and its offset
